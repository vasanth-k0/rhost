...
class Exe {
    ...
    async exe() {
        return new Promise((resolve, reject)=>{
            ...
            let cleanup;
            let output = "";
            let interpretter = (Object.keys(this.service.actions).includes(this.endpoint)) ? this.service.actions[this.endpoint] : null;
            if (interpretter) {
                ...
                reject("Invalid endpoint or action not defined for this app");
            }
